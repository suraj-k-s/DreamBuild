...
if(isMultipart)
{
   ...
   Iterator itr=items_list.iterator();
    ...
    //Strinh str1="insert into tbl_wantedlist ()";
        ...
        String str1="insert into tbl_land(location_id,land_image,land_tokenamount,land_address,landlord_id,land_details)values('"+value[0]+"','"+fn+"','"+value[1]+"','"+value[2]+"','"+session.getAttribute("landlordid")+"','"+value[3]+"')";
