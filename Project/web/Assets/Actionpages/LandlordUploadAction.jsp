<%-- 
    Document   : LandlordUploadAction
    Created on : 25 Jan, 2022, 2:05:30 PM
    Author     : asanj
--%>
...
if(isMultipart)
{
   ...
   Iterator itr=items_list.iterator();
    ...
    String s="select * from tbl_landlord where landlord_email='"+value[3]+"'";
    ResultSet r=con.selectCommand(s);
    String st="select * from tbl_user where user_email='"+value[3]+"'";
    ...
    else
    {
        if(value[8].equals(value[9]))
                {
        String str1="insert into tbl_landlord(landlord_name,landlord_gender,landlord_contact,landlord_email,landlord_dob,place_id,landlord_address,landlord_photo,landlord_proof,landlord_password,landlord_doj)values('"+value[0]+"','"+value[1]+"','"+value[2]+"','"+value[3]+"','"+value[4]+"','"+value[6]+"','"+value[7]+"','"+fn+"','"+fnp+"','"+value[8]+"',curdate())";
