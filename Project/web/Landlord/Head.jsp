...
<!--                                <a href="MyBooking.jsp" class="nav-item nav-link">Booking</a>
                                ...
                                <div class="nav-item dropdown">
                                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">User Land Request</a>
                                    <div class="dropdown-menu">
                                        <a href="ViewUserLandBookings.jsp" class="dropdown-item">New Request</a>
                                        <a href="ViewAcceptedLandBookings.jsp" class="dropdown-item">Accepted Request</a>
                                        <a href="ViewRejectedLandBookings.jsp" class="dropdown-item">Rejected Request</a>
                                    </div>
                                </div>
                                    <a href="BookingReport.jsp" class="nav-item nav-link">Report</a>
                                <div class="nav-item dropdown">
