    ...
    <body>
        ...
        <%
            if(request.getParameter("btnsave")!=null){
                String ins="insert into tbl_feedback(feedback_date,feedback_description,landlord_id) values (curdate(),'" + request.getParameter("feedback") + "','"+session.getAttribute("landlordid")+"')";
        ...
        <form  method="post">
            ...
            <table border="1" align="center" cellpadding="10">
                ...
                <%
                    String s = "select * from tbl_feedback where landlord_id='"+session.getAttribute("landlordid")+"'";
