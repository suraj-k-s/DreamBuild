...
<%
    ...
    {
        session.setAttribute("id", request.getParameter("sid"));
        session.setAttribute("wname", request.getParameter("wname"));
        session.setAttribute("wmail", request.getParameter("wmail"));
        session.setAttribute("uname", request.getParameter("uname"));
        session.setAttribute("umail", request.getParameter("umail"));
        String em=request.getParameter("wmail");
        String up="update tbl_servicebooking set servicebooking_pstatus='1' where servicebooking_id='"+session.getAttribute("id")+"'";
        ...
        if (status == true) {
                    ...
                    String subject = "Payment Status";
                        ...
                        String text = "Respected " + name + "  \r\n \r\n"
                                ...
                                + " Your payment for the service has been completed. \r\n Check it out... \r\n\r\n"
                    ...
                    String sub = "Payment Status";
                        ...
                        String txt = "Respected " + name1 + "  \r\n \r\n"
                                + " This is from Dream Build team. \r\n\r\n"
                                + " You have Completed the payment for the booked service. \r\n Check it out... \r\n\r\n"
                                + " We established Dream Build in order to bring the dream about your home come true. \r\n"
                                + " If you have any questions,and if there is anything we can improve please reply to this email. \r\n"
                                + " we were always happy to help!. \r\n \r\n"
                                + " Team Dream Build.";
