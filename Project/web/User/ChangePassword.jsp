<%-- 
    ...
    Created on : 26 Jan, 2022, 2:13:55 PM
    Author     : asanj
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            {
                String selu="select *  from tbl_user where user_id='"+session.getAttribute("userid")+"' and user_password='"+request.getParameter("txtpwd")+"'";
                ResultSet rsd=con.selectCommand(selu);
                if(rsd.next())
                {
                if((request.getParameter("txtpwd1")).equals(request.getParameter("txtpwd2")))
                {
               String up="update tbl_user set user_password='"+request.getParameter("txtpwd1")+"' where user_id='"+session.getAttribute("userid")+"' ";
