                ...
                <tr>
                    <%                        
                        ...
                        while (rw.next()) {
                            i++;
                    %>
                    <td><p style="text-align:center;border:1px solid #999;margin:22px;padding:10px"><img src="../Assets/Files/<%=rw.getString("land_image")%>" width="100" height="100"><br>
...
<script type="text/javascript">
    ...
    window.location = "LandBooking.jsp";
</script>
<%                    }
%>
