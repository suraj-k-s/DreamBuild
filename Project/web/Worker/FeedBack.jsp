    ...
    <body>
        ...
        <%
            if(request.getParameter("btnsave")!=null){
                String ins="insert into  tbl_feedback(feedback_date,feedback_description,worker_id) values (curdate(),'" + request.getParameter("feedback") + "','"+session.getAttribute("workerid")+"')";
        ...
        <form  method="post">
            ...
            <table border="1" align="center" cellpadding="10">
                ...
                <%
                    String s = "select * from tbl_feedback where worker_id='"+session.getAttribute("workerid")+"'";
