<%-- 
    ...
    Created on : 26 Jan, 2022, 2:58:26 PM
    Author     : asanj
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            {
                String selu="select *  from tbl_worker where worker_id='"+session.getAttribute("workerid")+"' and worker_password='"+request.getParameter("txtpwd")+"'";
                ResultSet rsd=con.selectCommand(selu);
                if(rsd.next())
                {
                if((request.getParameter("txtpwd1")).equals(request.getParameter("txtpwd2")))
                {
               String up="update tbl_worker set worker_password='"+request.getParameter("txtpwd1")+"' where worker_id='"+session.getAttribute("workerid")+"' ";
