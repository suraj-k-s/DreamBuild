        ...
        <div id="tab" align="center">
            ...
            <table border="1" align="center" cellpadding="10" style="margin-left: 350px">
                ...
                <tr>
                    ...
                    <td>
                        <img src="../Assets/Files/<%=r.getString("landlord_photo")%>" width="75" height="75">
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <a href="../Assets/Files/<%=r.getString("landlord_proof")%>"><%=r.getString("landlord_proof")%></a>
            ...
            <table border="1" align="center" cellpadding="10" style="margin-left: 350px">
                ...
                <tr>
                    ...
                    <td>
                        <img src="../Assets/Files/<%=rs.getString("landlord_photo")%>" width="75" height="75">
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <a href="../Assets/Files/<%=rs.getString("landlord_proof")%>"><%=rs.getString("landlord_proof")%></a>
            ...
            <table border="1" align="center" cellpadding="10" style="margin-left: 350px">
                ...
                <tr>
                    ...
                    <td>
                        <img src="../Assets/Files/<%=res.getString("landlord_photo")%>" width="75" height="75">
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <a href="../Assets/Files/<%=res.getString("landlord_proof")%>"><%=res.getString("landlord_proof")%></a>
