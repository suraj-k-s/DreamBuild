...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>DREAM BUILD - Template</title>
                           ...
                           <div class="navbar-nav mr-auto">
                                ...
                                <div class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="Guest/Landlord.jsp" class="dropdown-item">Landlord</a>
                                        <a href="Guest/Shop.jsp" class="dropdown-item">Shop</a>
                                        <a href="Guest/User.jsp" class="dropdown-item">User</a>
                                        <a href="Guest/Worker.jsp" class="dropdown-item">Worker</a>
                                    </div>
                                </div>
                                <a href="Login/Login.jsp" class="nav-item nav-link">Login</a>
                            </div>
                        </div>
                    </nav>
                </div>
            ...
            <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption">
                            <p class="animated fadeInRight">Professional Team</p>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3">
                            <div class="footer-contact">
                                ...
                                <p><i class="fa fa-envelope"></i>thedreambuildgroup@gmail.com</p>
