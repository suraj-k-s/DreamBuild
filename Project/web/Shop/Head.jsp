                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                           <div class="navbar-nav mr-auto">
                                ...
                                <a href="NewProduct.jsp" class="nav-item nav-link">Product Details</a>
                                <a href="OrderReport.jsp" class="nav-item nav-link">Order Report</a>
                                <a href="ViewUserBookings.jsp" class="nav-item nav-link">User Booking Orders</a>
