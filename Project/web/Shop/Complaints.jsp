...
<html>
    ...
    <%
        ...
        if(request.getParameter("btnsave")!=null)
        {
            ...
            String insQry = "insert into tbl_complaint(complaint_title,complaint_description,complaint_date,shop_id)values('"+title+"','"+Complaint+"',curdate(),'"+session.getAttribute("shopid")+"')";
    ...
    <body>
        ...
        <table border="1" align="center" cellpadding="10" style="border-collapse: collapse">
            ...
            <%
                    String s = "select * from tbl_complaint where shop_id='"+session.getAttribute("shopid")+"'";
